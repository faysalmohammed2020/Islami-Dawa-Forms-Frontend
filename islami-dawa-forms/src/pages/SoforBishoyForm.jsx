    ...
    <div className="mx-auto mt-8 max-w-4xl rounded bg-white p-4 shadow-lg">
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-10">
            <div>
              <label className="mb-2 block text-gray-700">মাদ্রাসা সফর হয়েছে</label>
              <Field
                name="MadrasaSofor"
            ...
            <div>
              <label className="mb-2 block text-gray-700">চলমান মাদ্রাসা সফর হয়েছে</label>
              <Field
                name="CholomanSofor"
                placeholder="Enter Value"
                className="w-full rounded border border-gray-300 px-4 py-2 mb-3"
